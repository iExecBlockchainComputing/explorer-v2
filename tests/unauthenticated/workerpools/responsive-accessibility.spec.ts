...
test.describe('Responsive Design and Accessibility', () => {
  test('Test responsive behavior and accessibility', async ({ page }) => {
    // Navigate to workerpools page on desktop viewport
    ...
    const workerpoolRows = page.getByRole('row').filter({ hasNot: page.getByRole('columnheader') });
    await expect(workerpoolRows.first()).toBeVisible();
