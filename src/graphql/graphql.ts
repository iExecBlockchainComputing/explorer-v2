...
export enum AccountEvent_OrderBy {
  Account = 'account',
  AccountBalance = 'account__balance',
  AccountFrozen = 'account__frozen',
  AccountId = 'account__id',
  AccountScore = 'account__score',
  Id = 'id',
  Timestamp = 'timestamp',
  Transaction = 'transaction',
...
export type AccurateContribution_Filter = {
  ...
  account_starts_with?: InputMaybe<Scalars['String']['input']>;
  account_starts_with_nocase?: InputMaybe<Scalars['String']['input']>;
  and?: InputMaybe<Array<InputMaybe<AccurateContribution_Filter>>>;
  ...
  id_not?: InputMaybe<Scalars['ID']['input']>;
  id_not_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  or?: InputMaybe<Array<InputMaybe<AccurateContribution_Filter>>>;
  score?: InputMaybe<Scalars['BigInt']['input']>;
  score_gt?: InputMaybe<Scalars['BigInt']['input']>;
  score_gte?: InputMaybe<Scalars['BigInt']['input']>;
  score_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
...
export enum AccurateContribution_OrderBy {
  ...
  AccountScore = 'account__score',
  Contribution = 'contribution',
  ContributionChallenge = 'contribution__challenge',
  ContributionHash = 'contribution__hash',
  ContributionId = 'contribution__id',
  ContributionSeal = 'contribution__seal',
  ContributionStatus = 'contribution__status',
  ContributionTimestamp = 'contribution__timestamp',
  Id = 'id',
  Score = 'score',
  Timestamp = 'timestamp',
  Transaction = 'transaction',
...
export type AppOrder_Filter = {
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
  and?: InputMaybe<Array<InputMaybe<AppOrder_Filter>>>;
  ...
  datasetrestrict_gt?: InputMaybe<Scalars['Bytes']['input']>;
  datasetrestrict_gte?: InputMaybe<Scalars['Bytes']['input']>;
  datasetrestrict_in?: InputMaybe<Array<Scalars['Bytes']['input']>>;
  datasetrestrict_lt?: InputMaybe<Scalars['Bytes']['input']>;
  datasetrestrict_lte?: InputMaybe<Scalars['Bytes']['input']>;
  ...
  id_not?: InputMaybe<Scalars['ID']['input']>;
  id_not_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  or?: InputMaybe<Array<InputMaybe<AppOrder_Filter>>>;
  requesterrestrict?: InputMaybe<Scalars['Bytes']['input']>;
  requesterrestrict_contains?: InputMaybe<Scalars['Bytes']['input']>;
  requesterrestrict_gt?: InputMaybe<Scalars['Bytes']['input']>;
  requesterrestrict_gte?: InputMaybe<Scalars['Bytes']['input']>;
  requesterrestrict_in?: InputMaybe<Array<Scalars['Bytes']['input']>>;
  requesterrestrict_lt?: InputMaybe<Scalars['Bytes']['input']>;
  requesterrestrict_lte?: InputMaybe<Scalars['Bytes']['input']>;
  ...
  sign_gt?: InputMaybe<Scalars['Bytes']['input']>;
  sign_gte?: InputMaybe<Scalars['Bytes']['input']>;
  sign_in?: InputMaybe<Array<Scalars['Bytes']['input']>>;
  sign_lt?: InputMaybe<Scalars['Bytes']['input']>;
  sign_lte?: InputMaybe<Scalars['Bytes']['input']>;
  ...
  tag_gt?: InputMaybe<Scalars['Bytes']['input']>;
  tag_gte?: InputMaybe<Scalars['Bytes']['input']>;
  tag_in?: InputMaybe<Array<Scalars['Bytes']['input']>>;
  tag_lt?: InputMaybe<Scalars['Bytes']['input']>;
  tag_lte?: InputMaybe<Scalars['Bytes']['input']>;
  ...
  workerpoolrestrict_gt?: InputMaybe<Scalars['Bytes']['input']>;
  workerpoolrestrict_gte?: InputMaybe<Scalars['Bytes']['input']>;
  workerpoolrestrict_in?: InputMaybe<Array<Scalars['Bytes']['input']>>;
  workerpoolrestrict_lt?: InputMaybe<Scalars['Bytes']['input']>;
  workerpoolrestrict_lte?: InputMaybe<Scalars['Bytes']['input']>;
...
export enum AppOrder_OrderBy {
  App = 'app',
  AppChecksum = 'app__checksum',
  AppId = 'app__id',
  AppMrenclave = 'app__mrenclave',
  AppMultiaddr = 'app__multiaddr',
  AppName = 'app__name',
  AppTimestamp = 'app__timestamp',
  AppType = 'app__type',
  Appprice = 'appprice',
...
export type AppTransfer_Filter = {
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
  and?: InputMaybe<Array<InputMaybe<AppTransfer_Filter>>>;
  app?: InputMaybe<Scalars['String']['input']>;
  app_?: InputMaybe<App_Filter>;
  app_contains?: InputMaybe<Scalars['String']['input']>;
  app_contains_nocase?: InputMaybe<Scalars['String']['input']>;
  ...
  id_not?: InputMaybe<Scalars['ID']['input']>;
  id_not_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  or?: InputMaybe<Array<InputMaybe<AppTransfer_Filter>>>;
  timestamp?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_gt?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_gte?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
...
export enum AppTransfer_OrderBy {
  ...
  FromFrozen = 'from__frozen',
  FromId = 'from__id',
  FromScore = 'from__score',
  Id = 'id',
  Timestamp = 'timestamp',
  To = 'to',
...
export type App_Filter = {
  ...
  checksum_gt?: InputMaybe<Scalars['Bytes']['input']>;
  checksum_gte?: InputMaybe<Scalars['Bytes']['input']>;
  checksum_in?: InputMaybe<Array<Scalars['Bytes']['input']>>;
  checksum_lt?: InputMaybe<Scalars['Bytes']['input']>;
  checksum_lte?: InputMaybe<Scalars['Bytes']['input']>;
  ...
  mrenclave_gt?: InputMaybe<Scalars['Bytes']['input']>;
  mrenclave_gte?: InputMaybe<Scalars['Bytes']['input']>;
  mrenclave_in?: InputMaybe<Array<Scalars['Bytes']['input']>>;
  mrenclave_lt?: InputMaybe<Scalars['Bytes']['input']>;
  mrenclave_lte?: InputMaybe<Scalars['Bytes']['input']>;
  ...
  multiaddr_gt?: InputMaybe<Scalars['Bytes']['input']>;
  multiaddr_gte?: InputMaybe<Scalars['Bytes']['input']>;
  multiaddr_in?: InputMaybe<Array<Scalars['Bytes']['input']>>;
  multiaddr_lt?: InputMaybe<Scalars['Bytes']['input']>;
  multiaddr_lte?: InputMaybe<Scalars['Bytes']['input']>;
...
export enum App_OrderBy {
  ...
  OwnerFrozen = 'owner__frozen',
  OwnerId = 'owner__id',
  OwnerScore = 'owner__score',
  Timestamp = 'timestamp',
  Transfers = 'transfers',
  Type = 'type',
  Usages = 'usages'
...
export type Contribution_Filter = {
  ...
  challenge_gt?: InputMaybe<Scalars['Bytes']['input']>;
  challenge_gte?: InputMaybe<Scalars['Bytes']['input']>;
  challenge_in?: InputMaybe<Array<Scalars['Bytes']['input']>>;
  challenge_lt?: InputMaybe<Scalars['Bytes']['input']>;
  challenge_lte?: InputMaybe<Scalars['Bytes']['input']>;
  ...
  seal_gt?: InputMaybe<Scalars['Bytes']['input']>;
  seal_gte?: InputMaybe<Scalars['Bytes']['input']>;
  seal_in?: InputMaybe<Array<Scalars['Bytes']['input']>>;
  seal_lt?: InputMaybe<Scalars['Bytes']['input']>;
  seal_lte?: InputMaybe<Scalars['Bytes']['input']>;
...
export enum Contribution_OrderBy {
  ...
  Status = 'status',
  Task = 'task',
  TaskConsensus = 'task__consensus',
  TaskContributionDeadline = 'task__contributionDeadline',
  TaskFinalDeadline = 'task__finalDeadline',
  TaskId = 'task__id',
  TaskIndex = 'task__index',
  TaskResultDigest = 'task__resultDigest',
  TaskResults = 'task__results',
  TaskResultsCallback = 'task__resultsCallback',
  TaskRevealDeadline = 'task__revealDeadline',
  TaskStatus = 'task__status',
  TaskTimestamp = 'task__timestamp',
  Timestamp = 'timestamp',
  Worker = 'worker',
  WorkerBalance = 'worker__balance',
  WorkerFrozen = 'worker__frozen',
  WorkerId = 'worker__id',
  WorkerScore = 'worker__score'
}
...
export type DatasetOrder_Filter = {
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
  and?: InputMaybe<Array<InputMaybe<DatasetOrder_Filter>>>;
  apprestrict?: InputMaybe<Scalars['Bytes']['input']>;
  apprestrict_contains?: InputMaybe<Scalars['Bytes']['input']>;
  apprestrict_gt?: InputMaybe<Scalars['Bytes']['input']>;
  apprestrict_gte?: InputMaybe<Scalars['Bytes']['input']>;
  apprestrict_in?: InputMaybe<Array<Scalars['Bytes']['input']>>;
  apprestrict_lt?: InputMaybe<Scalars['Bytes']['input']>;
  apprestrict_lte?: InputMaybe<Scalars['Bytes']['input']>;
  ...
  id_not?: InputMaybe<Scalars['ID']['input']>;
  id_not_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  or?: InputMaybe<Array<InputMaybe<DatasetOrder_Filter>>>;
  requesterrestrict?: InputMaybe<Scalars['Bytes']['input']>;
  requesterrestrict_contains?: InputMaybe<Scalars['Bytes']['input']>;
  requesterrestrict_gt?: InputMaybe<Scalars['Bytes']['input']>;
  requesterrestrict_gte?: InputMaybe<Scalars['Bytes']['input']>;
...
export enum DatasetOrder_OrderBy {
  ...
  Dataset = 'dataset',
  DatasetChecksum = 'dataset__checksum',
  DatasetId = 'dataset__id',
  DatasetMultiaddr = 'dataset__multiaddr',
  DatasetName = 'dataset__name',
  DatasetTimestamp = 'dataset__timestamp',
...
export type DatasetTransfer_Filter = {
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
  and?: InputMaybe<Array<InputMaybe<DatasetTransfer_Filter>>>;
  dataset?: InputMaybe<Scalars['String']['input']>;
  dataset_?: InputMaybe<Dataset_Filter>;
  dataset_contains?: InputMaybe<Scalars['String']['input']>;
  dataset_contains_nocase?: InputMaybe<Scalars['String']['input']>;
  ...
  id_not?: InputMaybe<Scalars['ID']['input']>;
  id_not_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  or?: InputMaybe<Array<InputMaybe<DatasetTransfer_Filter>>>;
  timestamp?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_gt?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_gte?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
...
export type Dataset_Filter = {
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
  and?: InputMaybe<Array<InputMaybe<Dataset_Filter>>>;
  checksum?: InputMaybe<Scalars['Bytes']['input']>;
  checksum_contains?: InputMaybe<Scalars['Bytes']['input']>;
  checksum_gt?: InputMaybe<Scalars['Bytes']['input']>;
  checksum_gte?: InputMaybe<Scalars['Bytes']['input']>;
  ...
  name_starts_with?: InputMaybe<Scalars['String']['input']>;
  name_starts_with_nocase?: InputMaybe<Scalars['String']['input']>;
  or?: InputMaybe<Array<InputMaybe<Dataset_Filter>>>;
...
export type DealEvent_Filter = {
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
  and?: InputMaybe<Array<InputMaybe<DealEvent_Filter>>>;
  ...
  id_not?: InputMaybe<Scalars['ID']['input']>;
  id_not_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  or?: InputMaybe<Array<InputMaybe<DealEvent_Filter>>>;
  timestamp?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_gt?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_gte?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
...
export enum DealEvent_OrderBy {
  Deal = 'deal',
  DealAppPrice = 'deal__appPrice',
  DealBotFirst = 'deal__botFirst',
  DealBotSize = 'deal__botSize',
  DealClaimedTasksCount = 'deal__claimedTasksCount',
  DealCompletedTasksCount = 'deal__completedTasksCount',
  DealDatasetPrice = 'deal__datasetPrice',
  DealId = 'deal__id',
  DealParams = 'deal__params',
  DealSchedulerRewardRatio = 'deal__schedulerRewardRatio',
  DealStartTime = 'deal__startTime',
  DealTag = 'deal__tag',
  DealTimestamp = 'deal__timestamp',
  DealTrust = 'deal__trust',
  DealWorkerStake = 'deal__workerStake',
  DealWorkerpoolPrice = 'deal__workerpoolPrice',
  Id = 'id',
  Timestamp = 'timestamp',
  Transaction = 'transaction',
  TransactionBlockNumber = 'transaction__blockNumber',
...
export type Deal_Filter = {
  ...
  events_?: InputMaybe<DealEvent_Filter>;
  id?: InputMaybe<Scalars['ID']['input']>;
  id_gt?: InputMaybe<Scalars['ID']['input']>;
  id_gte?: InputMaybe<Scalars['ID']['input']>;
  id_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  ...
  sponsor_?: InputMaybe<Account_Filter>;
...
export enum Deal_OrderBy {
  App = 'app',
  AppOwner = 'appOwner',
  AppOwnerBalance = 'appOwner__balance',
  AppOwnerFrozen = 'appOwner__frozen',
  AppOwnerId = 'appOwner__id',
  AppOwnerScore = 'appOwner__score',
  AppPrice = 'appPrice',
  AppChecksum = 'app__checksum',
  AppId = 'app__id',
  AppMrenclave = 'app__mrenclave',
  ...
  AppType = 'app__type',
  Apporder = 'apporder',
  ApporderAppprice = 'apporder__appprice',
  ApporderDatasetrestrict = 'apporder__datasetrestrict',
  ApporderId = 'apporder__id',
  ApporderRequesterrestrict = 'apporder__requesterrestrict',
  ApporderSalt = 'apporder__salt',
  ApporderSign = 'apporder__sign',
  ApporderTag = 'apporder__tag',
  ApporderVolume = 'apporder__volume',
  ApporderWorkerpoolrestrict = 'apporder__workerpoolrestrict',
  Beneficiary = 'beneficiary',
  BeneficiaryBalance = 'beneficiary__balance',
  BeneficiaryFrozen = 'beneficiary__frozen',
  BeneficiaryId = 'beneficiary__id',
  BeneficiaryScore = 'beneficiary__score',
  BotFirst = 'botFirst',
  BotSize = 'botSize',
  Callback = 'callback',
  CallbackBalance = 'callback__balance',
  CallbackFrozen = 'callback__frozen',
  CallbackId = 'callback__id',
  CallbackScore = 'callback__score',
  Category = 'category',
  CategoryDescription = 'category__description',
  CategoryId = 'category__id',
  CategoryName = 'category__name',
  CategoryTimestamp = 'category__timestamp',
  CategoryWorkClockTimeRef = 'category__workClockTimeRef',
  ClaimedTasksCount = 'claimedTasksCount',
  CompletedTasksCount = 'completedTasksCount',
  Dataset = 'dataset',
  DatasetOwner = 'datasetOwner',
  DatasetOwnerBalance = 'datasetOwner__balance',
  DatasetOwnerFrozen = 'datasetOwner__frozen',
  DatasetOwnerId = 'datasetOwner__id',
  DatasetOwnerScore = 'datasetOwner__score',
  DatasetPrice = 'datasetPrice',
  DatasetChecksum = 'dataset__checksum',
  DatasetId = 'dataset__id',
  DatasetMultiaddr = 'dataset__multiaddr',
  ...
  DatasetorderApprestrict = 'datasetorder__apprestrict',
  DatasetorderDatasetprice = 'datasetorder__datasetprice',
  DatasetorderId = 'datasetorder__id',
  DatasetorderRequesterrestrict = 'datasetorder__requesterrestrict',
  DatasetorderSalt = 'datasetorder__salt',
  DatasetorderSign = 'datasetorder__sign',
  DatasetorderTag = 'datasetorder__tag',
  DatasetorderVolume = 'datasetorder__volume',
  DatasetorderWorkerpoolrestrict = 'datasetorder__workerpoolrestrict',
  Events = 'events',
  Id = 'id',
  Params = 'params',
  Requester = 'requester',
  RequesterBalance = 'requester__balance',
  RequesterFrozen = 'requester__frozen',
  RequesterId = 'requester__id',
  RequesterScore = 'requester__score',
  Requestorder = 'requestorder',
  RequestorderAppmaxprice = 'requestorder__appmaxprice',
  RequestorderDatasetmaxprice = 'requestorder__datasetmaxprice',
  RequestorderId = 'requestorder__id',
  RequestorderParams = 'requestorder__params',
  RequestorderSalt = 'requestorder__salt',
  RequestorderSign = 'requestorder__sign',
  RequestorderTag = 'requestorder__tag',
  RequestorderTrust = 'requestorder__trust',
  RequestorderVolume = 'requestorder__volume',
  RequestorderWorkerpoolmaxprice = 'requestorder__workerpoolmaxprice',
  SchedulerRewardRatio = 'schedulerRewardRatio',
  Sponsor = 'sponsor',
  SponsorBalance = 'sponsor__balance',
  SponsorFrozen = 'sponsor__frozen',
  SponsorId = 'sponsor__id',
  SponsorScore = 'sponsor__score',
  StartTime = 'startTime',
  Tag = 'tag',
  Tasks = 'tasks',
  Timestamp = 'timestamp',
  ...
  WorkerpoolOwnerBalance = 'workerpoolOwner__balance',
  WorkerpoolOwnerFrozen = 'workerpoolOwner__frozen',
  WorkerpoolOwnerId = 'workerpoolOwner__id',
  WorkerpoolOwnerScore = 'workerpoolOwner__score',
  WorkerpoolPrice = 'workerpoolPrice',
  WorkerpoolDescription = 'workerpool__description',
  WorkerpoolId = 'workerpool__id',
  WorkerpoolSchedulerRewardRatio = 'workerpool__schedulerRewardRatio',
  WorkerpoolTimestamp = 'workerpool__timestamp',
  WorkerpoolWorkerStakeRatio = 'workerpool__workerStakeRatio',
  Workerpoolorder = 'workerpoolorder',
  WorkerpoolorderApprestrict = 'workerpoolorder__apprestrict',
  WorkerpoolorderDatasetrestrict = 'workerpoolorder__datasetrestrict',
  WorkerpoolorderId = 'workerpoolorder__id',
  WorkerpoolorderRequesterrestrict = 'workerpoolorder__requesterrestrict',
  WorkerpoolorderSalt = 'workerpoolorder__salt',
  WorkerpoolorderSign = 'workerpoolorder__sign',
  WorkerpoolorderTag = 'workerpoolorder__tag',
  WorkerpoolorderTrust = 'workerpoolorder__trust',
  WorkerpoolorderVolume = 'workerpoolorder__volume',
  WorkerpoolorderWorkerpoolprice = 'workerpoolorder__workerpoolprice'
}
...
export type Erc1538CommitMessage_Filter = {
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
  and?: InputMaybe<Array<InputMaybe<Erc1538CommitMessage_Filter>>>;
  id?: InputMaybe<Scalars['ID']['input']>;
  id_gt?: InputMaybe<Scalars['ID']['input']>;
  id_gte?: InputMaybe<Scalars['ID']['input']>;
  id_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  ...
  or?: InputMaybe<Array<InputMaybe<Erc1538CommitMessage_Filter>>>;
  timestamp?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_gt?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_gte?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
...
export type Erc1538Event_Filter = {
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
  and?: InputMaybe<Array<InputMaybe<Erc1538Event_Filter>>>;
  id?: InputMaybe<Scalars['ID']['input']>;
  id_gt?: InputMaybe<Scalars['ID']['input']>;
  id_gte?: InputMaybe<Scalars['ID']['input']>;
  id_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  ...
  id_not?: InputMaybe<Scalars['ID']['input']>;
  id_not_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  or?: InputMaybe<Array<InputMaybe<Erc1538Event_Filter>>>;
  timestamp?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_gt?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_gte?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
...
export type Erc1538FunctionUpdate_Filter = {
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
  and?: InputMaybe<Array<InputMaybe<Erc1538FunctionUpdate_Filter>>>;
  ...
  or?: InputMaybe<Array<InputMaybe<Erc1538FunctionUpdate_Filter>>>;
  timestamp?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_gt?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_gte?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
...
export enum Erc1538FunctionUpdate_OrderBy {
  ...
  FunctionIdId = 'functionId__id',
  FunctionIdName = 'functionId__name',
  Id = 'id',
  Newmodule = 'newmodule',
  NewmoduleId = 'newmodule__id',
  Oldmodule = 'oldmodule',
  OldmoduleId = 'oldmodule__id',
  Timestamp = 'timestamp',
  Transaction = 'transaction',
  TransactionBlockNumber = 'transaction__blockNumber',
  TransactionGasLimit = 'transaction__gasLimit',
...
export type Erc1538Function_Filter = {
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
  and?: InputMaybe<Array<InputMaybe<Erc1538Function_Filter>>>;
  id?: InputMaybe<Scalars['ID']['input']>;
  id_gt?: InputMaybe<Scalars['ID']['input']>;
  id_gte?: InputMaybe<Scalars['ID']['input']>;
  id_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  ...
  name_starts_with?: InputMaybe<Scalars['String']['input']>;
  name_starts_with_nocase?: InputMaybe<Scalars['String']['input']>;
  or?: InputMaybe<Array<InputMaybe<Erc1538Function_Filter>>>;
...
export type Erc1538Module_Filter = {
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
  and?: InputMaybe<Array<InputMaybe<Erc1538Module_Filter>>>;
  ...
  id_not?: InputMaybe<Scalars['ID']['input']>;
  id_not_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  or?: InputMaybe<Array<InputMaybe<Erc1538Module_Filter>>>;
};
...
export type FaultyContribution_Filter = {
  ...
  account_starts_with?: InputMaybe<Scalars['String']['input']>;
  account_starts_with_nocase?: InputMaybe<Scalars['String']['input']>;
  and?: InputMaybe<Array<InputMaybe<FaultyContribution_Filter>>>;
  contribution?: InputMaybe<Scalars['String']['input']>;
  contribution_?: InputMaybe<Contribution_Filter>;
  contribution_contains?: InputMaybe<Scalars['String']['input']>;
  contribution_contains_nocase?: InputMaybe<Scalars['String']['input']>;
  ...
  id_not?: InputMaybe<Scalars['ID']['input']>;
  id_not_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  or?: InputMaybe<Array<InputMaybe<FaultyContribution_Filter>>>;
  score?: InputMaybe<Scalars['BigInt']['input']>;
  score_gt?: InputMaybe<Scalars['BigInt']['input']>;
  score_gte?: InputMaybe<Scalars['BigInt']['input']>;
  score_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
...
export type OrdersMatched_Filter = {
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
  and?: InputMaybe<Array<InputMaybe<OrdersMatched_Filter>>>;
  deal?: InputMaybe<Scalars['String']['input']>;
  deal_?: InputMaybe<Deal_Filter>;
  deal_contains?: InputMaybe<Scalars['String']['input']>;
  deal_contains_nocase?: InputMaybe<Scalars['String']['input']>;
  ...
  id_not?: InputMaybe<Scalars['ID']['input']>;
  id_not_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  or?: InputMaybe<Array<InputMaybe<OrdersMatched_Filter>>>;
  timestamp?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_gt?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_gte?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
...
export type PolicyUpdate_Filter = {
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
  and?: InputMaybe<Array<InputMaybe<PolicyUpdate_Filter>>>;
  id?: InputMaybe<Scalars['ID']['input']>;
  id_gt?: InputMaybe<Scalars['ID']['input']>;
  id_gte?: InputMaybe<Scalars['ID']['input']>;
  id_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  ...
  or?: InputMaybe<Array<InputMaybe<PolicyUpdate_Filter>>>;
  timestamp?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_gt?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_gte?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
...
export type RequestOrder_Filter = {
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
  and?: InputMaybe<Array<InputMaybe<RequestOrder_Filter>>>;
  app?: InputMaybe<Scalars['String']['input']>;
  app_?: InputMaybe<App_Filter>;
  app_contains?: InputMaybe<Scalars['String']['input']>;
  app_contains_nocase?: InputMaybe<Scalars['String']['input']>;
  ...
  id_not?: InputMaybe<Scalars['ID']['input']>;
  id_not_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  or?: InputMaybe<Array<InputMaybe<RequestOrder_Filter>>>;
  params?: InputMaybe<Scalars['String']['input']>;
  params_contains?: InputMaybe<Scalars['String']['input']>;
  params_contains_nocase?: InputMaybe<Scalars['String']['input']>;
  params_ends_with?: InputMaybe<Scalars['String']['input']>;
...
export type RessourceTransferEvent_Filter = {
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
  and?: InputMaybe<Array<InputMaybe<RessourceTransferEvent_Filter>>>;
  from?: InputMaybe<Scalars['String']['input']>;
  from_?: InputMaybe<Account_Filter>;
  from_contains?: InputMaybe<Scalars['String']['input']>;
  from_contains_nocase?: InputMaybe<Scalars['String']['input']>;
  ...
  id_not?: InputMaybe<Scalars['ID']['input']>;
  id_not_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  or?: InputMaybe<Array<InputMaybe<RessourceTransferEvent_Filter>>>;
  timestamp?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_gt?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_gte?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
...
export type Ressource_Filter = {
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
  and?: InputMaybe<Array<InputMaybe<Ressource_Filter>>>;
  id?: InputMaybe<Scalars['ID']['input']>;
  id_gt?: InputMaybe<Scalars['ID']['input']>;
  id_gte?: InputMaybe<Scalars['ID']['input']>;
  id_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  ...
  id_not?: InputMaybe<Scalars['ID']['input']>;
  id_not_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  or?: InputMaybe<Array<InputMaybe<Ressource_Filter>>>;
  owner?: InputMaybe<Scalars['String']['input']>;
  owner_?: InputMaybe<Account_Filter>;
  owner_contains?: InputMaybe<Scalars['String']['input']>;
  owner_contains_nocase?: InputMaybe<Scalars['String']['input']>;
...
export type SchedulerNotice_Filter = {
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
  and?: InputMaybe<Array<InputMaybe<SchedulerNotice_Filter>>>;
  deal?: InputMaybe<Scalars['String']['input']>;
  deal_?: InputMaybe<Deal_Filter>;
  deal_contains?: InputMaybe<Scalars['String']['input']>;
  deal_contains_nocase?: InputMaybe<Scalars['String']['input']>;
  ...
  id_not?: InputMaybe<Scalars['ID']['input']>;
  id_not_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  or?: InputMaybe<Array<InputMaybe<SchedulerNotice_Filter>>>;
  timestamp?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_gt?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_gte?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
...
export type Seize_Filter = {
  ...
  account_starts_with?: InputMaybe<Scalars['String']['input']>;
  account_starts_with_nocase?: InputMaybe<Scalars['String']['input']>;
  and?: InputMaybe<Array<InputMaybe<Seize_Filter>>>;
  id?: InputMaybe<Scalars['ID']['input']>;
  id_gt?: InputMaybe<Scalars['ID']['input']>;
  id_gte?: InputMaybe<Scalars['ID']['input']>;
  id_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  ...
  id_not?: InputMaybe<Scalars['ID']['input']>;
  id_not_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  or?: InputMaybe<Array<InputMaybe<Seize_Filter>>>;
  task?: InputMaybe<Scalars['String']['input']>;
  task_?: InputMaybe<Task_Filter>;
  task_contains?: InputMaybe<Scalars['String']['input']>;
  task_contains_nocase?: InputMaybe<Scalars['String']['input']>;
...
export type TaskClaimed_Filter = {
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
  and?: InputMaybe<Array<InputMaybe<TaskClaimed_Filter>>>;
  id?: InputMaybe<Scalars['ID']['input']>;
  id_gt?: InputMaybe<Scalars['ID']['input']>;
  id_gte?: InputMaybe<Scalars['ID']['input']>;
  id_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  ...
  id_not?: InputMaybe<Scalars['ID']['input']>;
  id_not_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  or?: InputMaybe<Array<InputMaybe<TaskClaimed_Filter>>>;
  task?: InputMaybe<Scalars['String']['input']>;
  task_?: InputMaybe<Task_Filter>;
  task_contains?: InputMaybe<Scalars['String']['input']>;
  task_contains_nocase?: InputMaybe<Scalars['String']['input']>;
...
export type TaskConsensus_Filter = {
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
  and?: InputMaybe<Array<InputMaybe<TaskConsensus_Filter>>>;
  consensus?: InputMaybe<Scalars['Bytes']['input']>;
  consensus_contains?: InputMaybe<Scalars['Bytes']['input']>;
  consensus_gt?: InputMaybe<Scalars['Bytes']['input']>;
  consensus_gte?: InputMaybe<Scalars['Bytes']['input']>;
  consensus_in?: InputMaybe<Array<Scalars['Bytes']['input']>>;
  consensus_lt?: InputMaybe<Scalars['Bytes']['input']>;
  consensus_lte?: InputMaybe<Scalars['Bytes']['input']>;
  ...
  id_not?: InputMaybe<Scalars['ID']['input']>;
  id_not_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  or?: InputMaybe<Array<InputMaybe<TaskConsensus_Filter>>>;
  task?: InputMaybe<Scalars['String']['input']>;
  task_?: InputMaybe<Task_Filter>;
  task_contains?: InputMaybe<Scalars['String']['input']>;
  task_contains_nocase?: InputMaybe<Scalars['String']['input']>;
...
export type TaskContribute_Filter = {
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
  and?: InputMaybe<Array<InputMaybe<TaskContribute_Filter>>>;
  hash?: InputMaybe<Scalars['Bytes']['input']>;
  hash_contains?: InputMaybe<Scalars['Bytes']['input']>;
  hash_gt?: InputMaybe<Scalars['Bytes']['input']>;
  hash_gte?: InputMaybe<Scalars['Bytes']['input']>;
  ...
  id_not?: InputMaybe<Scalars['ID']['input']>;
  id_not_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  or?: InputMaybe<Array<InputMaybe<TaskContribute_Filter>>>;
  task?: InputMaybe<Scalars['String']['input']>;
  task_?: InputMaybe<Task_Filter>;
  task_contains?: InputMaybe<Scalars['String']['input']>;
  task_contains_nocase?: InputMaybe<Scalars['String']['input']>;
...
export type TaskEvent_Filter = {
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
  and?: InputMaybe<Array<InputMaybe<TaskEvent_Filter>>>;
  id?: InputMaybe<Scalars['ID']['input']>;
  id_gt?: InputMaybe<Scalars['ID']['input']>;
  id_gte?: InputMaybe<Scalars['ID']['input']>;
  id_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  ...
  id_not?: InputMaybe<Scalars['ID']['input']>;
  id_not_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  or?: InputMaybe<Array<InputMaybe<TaskEvent_Filter>>>;
  task?: InputMaybe<Scalars['String']['input']>;
  task_?: InputMaybe<Task_Filter>;
  task_contains?: InputMaybe<Scalars['String']['input']>;
  task_contains_nocase?: InputMaybe<Scalars['String']['input']>;
...
export type TaskFinalize_Filter = {
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
  and?: InputMaybe<Array<InputMaybe<TaskFinalize_Filter>>>;
  id?: InputMaybe<Scalars['ID']['input']>;
  id_gt?: InputMaybe<Scalars['ID']['input']>;
  id_gte?: InputMaybe<Scalars['ID']['input']>;
  id_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  ...
  id_not?: InputMaybe<Scalars['ID']['input']>;
  id_not_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  or?: InputMaybe<Array<InputMaybe<TaskFinalize_Filter>>>;
  results?: InputMaybe<Scalars['Bytes']['input']>;
  results_contains?: InputMaybe<Scalars['Bytes']['input']>;
  results_gt?: InputMaybe<Scalars['Bytes']['input']>;
  results_gte?: InputMaybe<Scalars['Bytes']['input']>;
  results_in?: InputMaybe<Array<Scalars['Bytes']['input']>>;
  results_lt?: InputMaybe<Scalars['Bytes']['input']>;
  results_lte?: InputMaybe<Scalars['Bytes']['input']>;
...
export type TaskInitialize_Filter = {
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
  and?: InputMaybe<Array<InputMaybe<TaskInitialize_Filter>>>;
  id?: InputMaybe<Scalars['ID']['input']>;
  id_gt?: InputMaybe<Scalars['ID']['input']>;
  id_gte?: InputMaybe<Scalars['ID']['input']>;
  id_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  ...
  id_not?: InputMaybe<Scalars['ID']['input']>;
  id_not_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  or?: InputMaybe<Array<InputMaybe<TaskInitialize_Filter>>>;
  task?: InputMaybe<Scalars['String']['input']>;
  task_?: InputMaybe<Task_Filter>;
  task_contains?: InputMaybe<Scalars['String']['input']>;
  task_contains_nocase?: InputMaybe<Scalars['String']['input']>;
...
export type TaskReopen_Filter = {
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
  and?: InputMaybe<Array<InputMaybe<TaskReopen_Filter>>>;
  id?: InputMaybe<Scalars['ID']['input']>;
  id_gt?: InputMaybe<Scalars['ID']['input']>;
  id_gte?: InputMaybe<Scalars['ID']['input']>;
  id_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  ...
  id_not?: InputMaybe<Scalars['ID']['input']>;
  id_not_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  or?: InputMaybe<Array<InputMaybe<TaskReopen_Filter>>>;
  task?: InputMaybe<Scalars['String']['input']>;
  task_?: InputMaybe<Task_Filter>;
  task_contains?: InputMaybe<Scalars['String']['input']>;
  task_contains_nocase?: InputMaybe<Scalars['String']['input']>;
...
export type TaskReveal_Filter = {
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
  and?: InputMaybe<Array<InputMaybe<TaskReveal_Filter>>>;
  digest?: InputMaybe<Scalars['Bytes']['input']>;
  digest_contains?: InputMaybe<Scalars['Bytes']['input']>;
  digest_gt?: InputMaybe<Scalars['Bytes']['input']>;
  digest_gte?: InputMaybe<Scalars['Bytes']['input']>;
  digest_in?: InputMaybe<Array<Scalars['Bytes']['input']>>;
  digest_lt?: InputMaybe<Scalars['Bytes']['input']>;
  digest_lte?: InputMaybe<Scalars['Bytes']['input']>;
  ...
  id_not?: InputMaybe<Scalars['ID']['input']>;
  id_not_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  or?: InputMaybe<Array<InputMaybe<TaskReveal_Filter>>>;
  task?: InputMaybe<Scalars['String']['input']>;
  task_?: InputMaybe<Task_Filter>;
  task_contains?: InputMaybe<Scalars['String']['input']>;
  task_contains_nocase?: InputMaybe<Scalars['String']['input']>;
...
export type Task_Filter = {
  ...
  deal_starts_with?: InputMaybe<Scalars['String']['input']>;
  deal_starts_with_nocase?: InputMaybe<Scalars['String']['input']>;
  events_?: InputMaybe<TaskEvent_Filter>;
  ...
  resultDigest_gt?: InputMaybe<Scalars['Bytes']['input']>;
  resultDigest_gte?: InputMaybe<Scalars['Bytes']['input']>;
  resultDigest_in?: InputMaybe<Array<Scalars['Bytes']['input']>>;
  resultDigest_lt?: InputMaybe<Scalars['Bytes']['input']>;
  resultDigest_lte?: InputMaybe<Scalars['Bytes']['input']>;
...
export type Transaction_Filter = {
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
  accountEvents_?: InputMaybe<AccountEvent_Filter>;
  ...
  erc1538Events_?: InputMaybe<Erc1538Event_Filter>;
  from?: InputMaybe<Scalars['String']['input']>;
  from_?: InputMaybe<Account_Filter>;
  from_contains?: InputMaybe<Scalars['String']['input']>;
  from_contains_nocase?: InputMaybe<Scalars['String']['input']>;
  ...
  ressourceTransferEvent_?: InputMaybe<RessourceTransferEvent_Filter>;
  taskEvents_?: InputMaybe<TaskEvent_Filter>;
  timestamp?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_gt?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_gte?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
  ...
  workerpoolEvents_?: InputMaybe<WorkerpoolEvent_Filter>;
};
...
export type WorkerpoolEvent_Filter = {
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
  and?: InputMaybe<Array<InputMaybe<WorkerpoolEvent_Filter>>>;
  id?: InputMaybe<Scalars['ID']['input']>;
  id_gt?: InputMaybe<Scalars['ID']['input']>;
  id_gte?: InputMaybe<Scalars['ID']['input']>;
  id_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  ...
  id_not?: InputMaybe<Scalars['ID']['input']>;
  id_not_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  or?: InputMaybe<Array<InputMaybe<WorkerpoolEvent_Filter>>>;
  timestamp?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_gt?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_gte?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
...
export type WorkerpoolOrder_Filter = {
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
  and?: InputMaybe<Array<InputMaybe<WorkerpoolOrder_Filter>>>;
  apprestrict?: InputMaybe<Scalars['Bytes']['input']>;
  apprestrict_contains?: InputMaybe<Scalars['Bytes']['input']>;
  apprestrict_gt?: InputMaybe<Scalars['Bytes']['input']>;
  apprestrict_gte?: InputMaybe<Scalars['Bytes']['input']>;
  ...
  id_not?: InputMaybe<Scalars['ID']['input']>;
  id_not_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  or?: InputMaybe<Array<InputMaybe<WorkerpoolOrder_Filter>>>;
  requesterrestrict?: InputMaybe<Scalars['Bytes']['input']>;
  requesterrestrict_contains?: InputMaybe<Scalars['Bytes']['input']>;
  requesterrestrict_gt?: InputMaybe<Scalars['Bytes']['input']>;
  requesterrestrict_gte?: InputMaybe<Scalars['Bytes']['input']>;
...
export type WorkerpoolTransfer_Filter = {
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
  and?: InputMaybe<Array<InputMaybe<WorkerpoolTransfer_Filter>>>;
  from?: InputMaybe<Scalars['String']['input']>;
  from_?: InputMaybe<Account_Filter>;
  from_contains?: InputMaybe<Scalars['String']['input']>;
  from_contains_nocase?: InputMaybe<Scalars['String']['input']>;
  ...
  id_not?: InputMaybe<Scalars['ID']['input']>;
  id_not_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  or?: InputMaybe<Array<InputMaybe<WorkerpoolTransfer_Filter>>>;
  timestamp?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_gt?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_gte?: InputMaybe<Scalars['BigInt']['input']>;
  timestamp_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
...
export type Workerpool_Filter = {
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
  and?: InputMaybe<Array<InputMaybe<Workerpool_Filter>>>;
  description?: InputMaybe<Scalars['String']['input']>;
  description_contains?: InputMaybe<Scalars['String']['input']>;
  description_contains_nocase?: InputMaybe<Scalars['String']['input']>;
  description_ends_with?: InputMaybe<Scalars['String']['input']>;
  ...
  description_starts_with?: InputMaybe<Scalars['String']['input']>;
  description_starts_with_nocase?: InputMaybe<Scalars['String']['input']>;
  events_?: InputMaybe<WorkerpoolEvent_Filter>;
  id?: InputMaybe<Scalars['ID']['input']>;
  id_gt?: InputMaybe<Scalars['ID']['input']>;
  id_gte?: InputMaybe<Scalars['ID']['input']>;
  id_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  ...
  id_not?: InputMaybe<Scalars['ID']['input']>;
  id_not_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  or?: InputMaybe<Array<InputMaybe<Workerpool_Filter>>>;
...
export type NextAddressAppsQuery = { __typename?: 'Query', account?: { __typename?: 'Account', address: string, apps: Array<{ __typename?: 'App', address: string }> } | null };

export type AddressDatasetsQueryVariables = Exact<{
  length?: InputMaybe<Scalars['Int']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
  address: Scalars['ID']['input'];
}>;
...
export type AddressDatasetsQuery = { __typename?: 'Query', account?: { __typename?: 'Account', address: string, datasets: Array<{ __typename?: 'Dataset', name: string, timestamp: any, address: string, transfers: Array<{ __typename?: 'DatasetTransfer', transaction: { __typename?: 'Transaction', txHash: string } }> }> } | null };

export type NextAddressDatasetsQueryVariables = Exact<{
  length?: InputMaybe<Scalars['Int']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
  address: Scalars['ID']['input'];
}>;
...
export type NextAddressDatasetsQuery = { __typename?: 'Query', account?: { __typename?: 'Account', address: string, datasets: Array<{ __typename?: 'Dataset', address: string }> } | null };
...
export type AddressWorkerpoolsQueryVariables = Exact<{
  length?: InputMaybe<Scalars['Int']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
  address: Scalars['ID']['input'];
}>;
...
export type AddressWorkerpoolsQuery = { __typename?: 'Query', account?: { __typename?: 'Account', address: string, workerpools: Array<{ __typename?: 'Workerpool', description: string, timestamp: any, address: string, transfers: Array<{ __typename?: 'WorkerpoolTransfer', transaction: { __typename?: 'Transaction', txHash: string } }> }> } | null };

export type NextAddressWorkerpoolsQueryVariables = Exact<{
  length?: InputMaybe<Scalars['Int']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
  address: Scalars['ID']['input'];
}>;
...
export type NextAddressWorkerpoolsQuery = { __typename?: 'Query', account?: { __typename?: 'Account', address: string, workerpools: Array<{ __typename?: 'Workerpool', address: string }> } | null };
...
export const AddressDatasetsDocument = new TypedDocumentString(`
    query AddressDatasets($length: Int = 20, $skip: Int = 0, $address: ID!) {
  account(id: $address) {
    address: id
    datasets(orderBy: timestamp, orderDirection: desc, first: $length, skip: $skip) {
      address: id
      name
      timestamp
      transfers(orderBy: timestamp, orderDirection: desc) {
    ...
    `) as unknown as TypedDocumentString<AddressDatasetsQuery, AddressDatasetsQueryVariables>;
export const NextAddressDatasetsDocument = new TypedDocumentString(`
  ...
  account(id: $address) {
    ...
    `) as unknown as TypedDocumentString<NextAddressDatasetsQuery, NextAddressDatasetsQueryVariables>;
...
export const AddressWorkerpoolsDocument = new TypedDocumentString(`
  ...
  account(id: $address) {
    ...
    `) as unknown as TypedDocumentString<AddressWorkerpoolsQuery, AddressWorkerpoolsQueryVariables>;
export const NextAddressWorkerpoolsDocument = new TypedDocumentString(`
  ...
  account(id: $address) {
    ...
    `) as unknown as TypedDocumentString<NextAddressWorkerpoolsQuery, NextAddressWorkerpoolsQueryVariables>;
